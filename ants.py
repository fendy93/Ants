...
class Place:
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            "*** YOUR CODE HERE ***"
            if insect.name == 'Queen' and insect.counter == 0:
                return
            if insect.container == True and insect.ant:
                self.ant = insect.ant
            else:
                self.ant = None
        else:
...
class Ant(Insect):
    ...
    def can_contain(self, other):
        """Check if this Ant can contain another ant"""
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        "*** YOUR CODE HERE ***"
        count = 0
        init_place = self.place
        while True:
            if init_place == None:
                break
            target = random_or_none(init_place.bees)
            if target != None and init_place != hive and count >= self.min_range and count <= self.max_range:
                return target
            count += 1
            init_place = init_place.entrance
        return None
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        "*** YOUR CODE HERE ***"
        damaged_bees = list(self.place.bees)
...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    def __init__(self):
        "*** YOUR CODE HERE ***"
        ScubaThrower.__init__(self, self.armor)
        self.counter = self.queen_counter
    ...
    def action(self, colony):
        ...
        if self.counter > 0:
            ...
            forward = self.place.entrance
            while backward != None:
                if backward.ant and backward.ant.buffed == False:
                    backward.ant.damage *= 2
                    backward.ant.buffed = True
                    if type(backward.ant) == BodyguardAnt and backward.ant.ant and backward.ant.ant.buffed == False:
                        backward.ant.ant.damage *= 2
                        backward.ant.ant.buffed = True
                backward = backward.exit
            while forward != None:
                if forward.ant and forward.ant.buffed == False:
                    forward.ant.damage *= 2
                    forward.ant.buffed = True
                if type(forward.ant) == BodyguardAnt and forward.ant.ant and forward.ant.ant.buffed == False:
                        forward.ant.ant.damage *= 2
                        forward.ant.ant.buffed = True
